  ...
  const renderForm = () => {
    ...
    return (
      <form className="flex flex-col items-center" onSubmit={handleFormSubmit}>
        ...
        <input className='mb-8 bg-gray-300 pl-2 pr-24 py-1 rounded text-darkest' placeholder="City" name="location" type="text" value={formState.location} onChange={handleChange} />
